...
public class RegisterView {
	...
	public RegisterView() {
		...
		this.registerView.setSize(500, 290); // JFrame dimensions
		this.registerView.setLocationRelativeTo(null); // Centering JFrame vertically and horizontally
		this.registerView.setTitle(" TINDER"); // Setting the title of the window
